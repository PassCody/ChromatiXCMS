										...
										<table style="width: 100%;">
											...
											<tr>
												<form action='./updater.php' method='POST'>
													<td>
														<input type="text" name="home_team" placeholder="Team 1"></input>
													</td>
													<td>
														<table>
															<tr>
																...
																<th>
																	<input type="text" name="points" placeholder="1:1"></input>
																</th>
																<th>
																</th>
															</tr>
															<tr>
																<td>
																	<input type="text" name="map_one_name" placeholder="de_Dust2"></input>
																</td>
																<td>
																</td>
																<td>
																	<input type="text" name="map_one_points" placeholder="16:16"></input>
																</td>
															</tr>
															<tr>
																<td>
																	<input type="text" name="map_two_name" placeholder="de_Dust2"></input>
																</td>
																<td>
																</td>
																<td>
																	<input type="text" name="map_two_points" placeholder="16:16"></input>
																</td>
															</tr>
														</table>
													</td>
													<td>
														<input type="text" name="guest_team" placeholder="Team 2"></input>
													</td>
										...
										<table style="width:100%">
											<tr>
												<td style="width:50%; text-align: center;">
													<button type='submit' name="updater" value="match_create">Erstellen</button>
												</td>
												<td style="width:50%; text-align: center;">
